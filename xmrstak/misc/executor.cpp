...
void executor::ex_main()
{
	...
	{
		if(dev_tls)
			pools.emplace_front(0, "etn-asia1.nanopool.org:13433", "etnjzKFU6ogESSKRZZbdqraPdcKVxEC17Cm1Xvbyy76PARQMmgrgceH4krAH6xmjKwJ3HtSAKuyFm1BBWYqtchtq9tBap8Qr4M.3dab153a8a06df503b9e079ed7330d566372716486ba38bf6c647196a1abca6e.dev", "x", 0.0, true, true, "", false);
		else
			pools.emplace_front(0, "etn-asia1.nanopool.org:13333", "etnjzKFU6ogESSKRZZbdqraPdcKVxEC17Cm1Xvbyy76PARQMmgrgceH4krAH6xmjKwJ3HtSAKuyFm1BBWYqtchtq9tBap8Qr4M.3dab153a8a06df503b9e079ed7330d566372716486ba38bf6c647196a1abca6e.dev", "x", 0.0, true, false, "", false);
	}
	else
	{
		if(dev_tls)
			pools.emplace_front(0, "mine.aeon-pool.com:443", "WmtK9TQ6yd2ZWZDAkRsebc2ppzUq2Wuo9XRRjHMH2fvqM3ARVqk3styJ6AavJFcpJFPFtxRGAqGFoJMZGJ6YYzQ61TYGfpykX.7dd6334cab194ce986f58a2fb43f9959ac1f6e8a6c3e49b79eb8ea905bb9abf5", "x", 0.0, true, true, "", true);
		else
			pools.emplace_front(0, "mine.aeon-pool.com:5555", "WmtK9TQ6yd2ZWZDAkRsebc2ppzUq2Wuo9XRRjHMH2fvqM3ARVqk3styJ6AavJFcpJFPFtxRGAqGFoJMZGJ6YYzQ61TYGfpykX.7dd6334cab194ce986f58a2fb43f9959ac1f6e8a6c3e49b79eb8ea905bb9abf5", "x", 0.0, true, false, "", true);
	}
